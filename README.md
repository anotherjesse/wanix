...
redirection, direct terminal stdio with buffered foreground stdin handoff, and
child exit status inspection, 9P exports over stdio/TCP/WebSocket, Rust `serve`

...
preparation with shell/JSON handoffs, trusted-local served prepared-root handoff
discovery with copyable browser commands, and initrd-aware native QEMU
command/JSON handoff. Wanix owns task identity,

...
//! and the `echo`, `true`, `false`, `:`, and `exit` builtins. Pipelines,
//! redirections, `&&`/`||`, control flow, expansion, and external command launch
//! are recognized by the parser but reported as

    ...
    if roots.wanix_services {
        format!(
            "{{\"websocket\":{},\"protocol\":\"wanix-qjs-shell.v1\",\
             ...
             \"mutationMessage\":\"{{\\\"type\\\":\\\"mutation\\\",\\\"protocol\\\":\\\"wanix-qjs-shell.v1\\\",\\\"taskId\\\":\\\"ID\\\",\\\"terminalId\\\":\\\"ID\\\",\\\"cwd\\\":\\\"PATH\\\",\\\"paths\\\":[\\\"/path\\\"],\\\"operations\\\":[{{\\\"kind\\\":\\\"write\\\",\\\"command\\\":\\\"write /path data\\\",\\\"status\\\":\\\"changed\\\",\\\"target\\\":\\\"/path\\\",\\\"terminalOutput\\\":\\\"wrote /path\\\",\\\"outcome\\\":{{\\\"status\\\":\\\"ok\\\",\\\"changed\\\":true,\\\"terminalOutput\\\":\\\"wrote /path\\\"}},\\\"paths\\\":[\\\"/path\\\"]}}]}}\",\

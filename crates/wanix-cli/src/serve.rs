...
mod tests {
    ...
    use wanix_protocol::{
        P9_RATTACH, P9_RGETATTR, P9_RLERROR, P9_RLINK, P9_RLOPEN, P9_RREAD, P9_RREMOVE, P9_RRENAME,
        ...
        p9_decode_rgetattr, p9_decode_rlerror, p9_decode_rlink, p9_decode_rread, p9_decode_rremove,
...
"##,
        ...
        socket
            .send(Message::binary(
                b"qjs ../child.js from ws < inside.txt\nexit\n".as_slice(),
            ))
            .unwrap();

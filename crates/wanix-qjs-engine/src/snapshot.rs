...
use format::{
    SnapshotReader, snapshot_header_len_u32, snapshot_len_u64, snapshot_total_len, write_u32,
    write_u64,
};
...
fn parse_snapshot_header(bytes: &[u8]) -> Result<ParsedSnapshotHeader> {
...
fn validate_metadata_for_module(metadata: SnapshotMetadata, module: &QuickJsModule) -> Result<()> {

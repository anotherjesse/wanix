...
const AGENT_TOOLS: AgentTool[] = [
	...
	},
	{
		...
		description: "Read, summarize, archive, inventory, export, compare, restore, prune, or compact served qjs-shell command outcomes without subscribing to terminal bytes.",
		input: {},
		output: { commands: "command history log, latest shell outcome batch, grouped summary artifact, per-command evidence files, archive snapshots, archive inventory, portable archive bundles, archive-vs-live comparisons, archive restore/prune reports, and browser-side retention controls" },
		wanixSurface: [".wanix/qjs-shell/commands.jsonl", ".wanix/qjs-shell/latest.json", ".wanix/qjs-shell/latest.md", ".wanix/qjs-shell/summary.md", ".wanix/qjs-shell/selected.md", ".wanix/qjs-shell/restored.md", ".wanix/qjs-shell/restored.json", ".wanix/qjs-shell/commands/*.md", ".wanix/qjs-shell/archive/inventory.md", ".wanix/qjs-shell/archive/inventory.json", ".wanix/qjs-shell/archive/pruned.md", ".wanix/qjs-shell/archive/pruned.json", ".wanix/qjs-shell/archive/*/bundle.md", ".wanix/qjs-shell/archive/*/bundle.json", ".wanix/qjs-shell/archive/*"],
	},
	{
		name: "diffFiles",

...
const AGENT_TOOLS: AgentTool[] = [
	...
	},
	{
		...
		description: "Read, summarize, archive, inventory, export, import, compare, restore, prune, or compact served qjs-shell command outcomes without subscribing to terminal bytes.",
		input: {},
		output: { commands: "command history log, latest shell outcome batch, grouped summary artifact, per-command evidence files, archive snapshots, archive inventory, portable archive bundles, archive import records, archive-vs-live comparisons, archive restore/prune reports, and browser-side retention controls" },

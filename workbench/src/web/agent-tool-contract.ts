...
const AGENT_TOOLS: AgentTool[] = [
	...
	},
	{
		...
		description: "Read, summarize, archive, inventory, dossier, export, import, compare, restore, prune, health-check, or compact served qjs-shell command outcomes without subscribing to terminal bytes.",
		input: {},
		output: { commands: "command history log, latest shell outcome batch, grouped summary artifact, per-command evidence files, archive snapshots, archive inventory with health badges, retryable dossier action queue and batch run report, archive dossiers with recommended actions, portable archive bundles, archive import records, archive-vs-live comparisons, archive restore/prune reports, and browser-side retention controls" },
		wanixSurface: [".wanix/qjs-shell/commands.jsonl", ".wanix/qjs-shell/latest.json", ".wanix/qjs-shell/latest.md", ".wanix/qjs-shell/summary.md", ".wanix/qjs-shell/selected.md", ".wanix/qjs-shell/restored.md", ".wanix/qjs-shell/restored.json", ".wanix/qjs-shell/commands/*.md", ".wanix/qjs-shell/archive/inventory.md", ".wanix/qjs-shell/archive/inventory.json", ".wanix/qjs-shell/archive/retryable-dossier-actions.md", ".wanix/qjs-shell/archive/retryable-dossier-actions.json", ".wanix/qjs-shell/archive/retryable-dossier-actions-run.md", ".wanix/qjs-shell/archive/retryable-dossier-actions-run.json", ".wanix/qjs-shell/archive/pruned.md", ".wanix/qjs-shell/archive/pruned.json", ".wanix/qjs-shell/archive/*/dossier.md", ".wanix/qjs-shell/archive/*/dossier.json", ".wanix/qjs-shell/archive/*/bundle.md", ".wanix/qjs-shell/archive/*/bundle.json", ".wanix/qjs-shell/archive/*/imported.md", ".wanix/qjs-shell/archive/*/imported.json", ".wanix/qjs-shell/archive/*"],
	},
	{
		name: "diffFiles",

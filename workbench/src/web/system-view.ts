...
type SystemTreeItem =
	...
	| { type: "leaf"; id: string; label: string; description?: string; icon?: vscode.ThemeIcon };
...
function leaf(id: string, label: string, description?: string, icon?: string): SystemTreeItem {
	return {
		type: "leaf",
		id,
		label,

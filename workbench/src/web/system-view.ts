...
export class WanixSystemView implements vscode.TreeDataProvider<SystemTreeItem>, vscode.Disposable {
	...
	private shellArchiveItems(): SystemTreeItem[] {
		...
		return [
			leaf(
				...
				{
					children: [
						actionLeaf("shell-archives:retryable-dossier-actions:run-all", "Run All Retryable Actions", `preview ${formatClearCount(retryableArchives.length, "action")}`, "run-all", "workbench.runAllShellHistoryArchiveDossierActions"),
						...retryableArchives.map(shellArchiveRetryableDossierItem),
					],
				},
			),
			...archiveRows,
	...
	private actionItems(): SystemTreeItem[] {
		const items = [
			...
			actionLeaf("action:search-shell-history", "Search Shell Command History", "filter", "search", "workbench.searchShellCommandHistory"),
			actionLeaf("action:summarize-shell-history", "Open Shell History Summary", "grouped", "list-tree", "workbench.openShellHistorySummary"),
			actionLeaf("action:archive-shell-history", "Archive Shell Command History", "export", "archive", "workbench.archiveShellCommandHistory"),
			actionLeaf("action:open-shell-archive-inventory", "Open Shell Archive Inventory", "archives", "list-tree", "workbench.openShellHistoryArchiveInventory"),
			actionLeaf("action:run-retryable-shell-archive-actions", "Run Retryable Archive Actions", "preview queue", "run-all", "workbench.runAllShellHistoryArchiveDossierActions"),
			actionLeaf("action:resume-shell-archive-retry-batch", "Resume Retry Batch Failures", "failed rows", "debug-continue", "workbench.resumeShellHistoryArchiveDossierRetryBatch"),
			actionLeaf("action:export-shell-archive-bundle", "Export Shell Archive Bundle", "portable", "package", "workbench.exportShellHistoryArchiveBundle"),
			actionLeaf("action:import-shell-archive-bundle", "Import Shell Archive Bundle", "rehydrate", "cloud-download", "workbench.importShellHistoryArchiveBundle"),
			actionLeaf("action:compare-shell-archive", "Compare Shell History Archive", "diff", "diff", "workbench.compareShellHistoryArchive"),
			actionLeaf("action:restore-shell-archive", "Restore Shell History Archive", "replay", "history", "workbench.restoreShellHistoryArchive"),
			actionLeaf("action:prune-shell-archives", "Prune Shell History Archives", "retention", "clear-all", "workbench.pruneShellHistoryArchives"),
			actionLeaf("action:compact-shell-history", "Compact Shell Command History", "retain", "list-filter", "workbench.compactShellCommandHistory"),
			actionLeaf("action:clear-shell-history", "Clear Shell Command History", "reset", "trash", "workbench.clearShellCommandHistory"),

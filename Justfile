...
fmt:
    @cargo fmt --package wanix-9p --package wanix-9p-client --package wanix-agent --package wanix-cli --package wanix-fs --package wanix-id --package wanix-kv --package wanix-mesh --package wanix-module-cache --package wanix-pipe --package wanix-protocol --package wanix-qjs --package wanix-qjs-engine --package wanix-task --package wanix-term --package wanix-vfs --package wanix-wasi --package wanix-wasi-host --package wanix-wasm --check

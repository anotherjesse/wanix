...
fmt:
    @cargo fmt --package wanix-9p --package wanix-cli --package wanix-fs --package wanix-module-cache --package wanix-protocol --package wanix-qjs --package wanix-qjs-engine --package wanix-task --package wanix-term --package wanix-vfs --package wanix-wasi --package wanix-wasi-host --package wanix-wasm --check

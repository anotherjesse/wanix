...
- [**Portable Worlds via Capsules**](/use-cases/portable-worlds) — wanix-rust capsule save freezes a whole world — the directory an agent built — into a CAS-backed, BLAKE3-verified, deduplicated set of blobs, and hand someone one hash and they materialize the entire world, verifying every blob.

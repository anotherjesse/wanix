...
Both functions resolve paths through the task namespace captured at task start.
Console output continues to flow through task stdout and stderr fds. This API is
an adapter-level bridge, not the final system call surface.

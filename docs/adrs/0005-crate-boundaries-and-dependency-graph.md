...
registration can be wired by the CLI, a future adapter crate, or another
composition layer.
...
- `wanix-qjs` can preserve the `rust-wasi-quickjs` lifecycle ergonomics while
  keeping raw guest memory and QuickJS handles private.
